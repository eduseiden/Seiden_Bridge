...
A versão **0.8.1** preserva o funcionamento construído para o **EVO** na versão 0.7.0 e adiciona o **MQTT** como primeira origem assíncrona de eventos.

> **Seiden Bridge transforma eventos de múltiplas origens em eventos padronizados.**


## Configuração MQTT na 0.8.1
...
A versão 0.8.1 mantém as entidades operacionais já existentes para o EVO:
...
## Atualização da 0.7.0 para a 0.8.1

1. Faça backup da configuração atual.
2. Atualize o repositório de add-ons.
3. Instale ou atualize o Seiden Bridge para a versão 0.8.1.
...
A versão 0.7.0 criou a base de conectores e introduziu `connections` como modelo principal. A versão 0.8.1 utiliza essa base para adicionar o MQTT sem remover ou substituir o conector EVO.
